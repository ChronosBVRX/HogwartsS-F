...
begin
  ...
  values (p_duel_id, p_turn_number, 'turn_resolved', jsonb_build_object(
    ...
    'p1_total_dmg', v_p1_total_dmg,
    'p2_total_dmg', v_p2_total_dmg,
    'p1_strategy_bonus', v_p1_bonus,
    'p1_stance_bonus', v_p1_stance_dmg,
    'p2_strategy_bonus', v_p2_bonus,
    'p2_stance_bonus', v_p2_stance_dmg,
