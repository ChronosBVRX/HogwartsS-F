...
const STOCK_IMAGES = {
  "Hamburguesas": "/categories/hamburguesas.jpg",
  "Alitas de Fenix": "/categories/alitas.jpg",
  "Boneless de Hipogrifo": "/categories/boneless.jpg",
  "Snacks": "/categories/snacks.jpg",
  "Comida Mexicana": "/categories/mexicana.jpg",
  "Cajitas Mágicas": "/categories/cajitas.jpg",
  "Ensaladas": "/categories/ensaladas.jpg",

  "Cold Brew": "/categories/coldbrew.jpg",
  "Frappes y Malteadas": "/categories/frappes.jpg",

  "Infusiones (Café)": "/categories/infusiones.jpg",
  "Café Expreso": "/categories/expreso.jpg",
  "Tés y Postres": "/categories/postres.jpg",

  "Carajillos (Bebidas heladas)": "/categories/carajillos.jpg",
  "Bebidas con Alcohol": "/categories/alcohol.jpg",
  "Especial de las casas": "/categories/carajillos.jpg",
  "Clericot": "/categories/clericot.jpg",
  "En copa": "/categories/alcohol.jpg",
  "Cerveza y Cocteles": "/categories/cerveza.jpg",

  "Refrescos y Aguas": "/categories/refrescos.jpg",

  "Crepas Delux": "/categories/crepas_delux.jpg",
  "Crepas Clásicas": "/categories/crepas_clasicas.jpg",
  "Nuevos Productos": "/categories/hamburguesas.jpg",
...
export default function Menu() {
  ...
  const fetchMenuData = async () => {
    const cacheKey = 'hsf_menu_cache_v5'
